...
def __create_raw_scrfd(img_filepath):
...
def __resize_square_to_jpg(src, dst):
    ...
    src_img = src_img.resize((672, 672),resample=Image.BILINEAR)
...
def convert_img(src,dest):
    print("Converting images for scrfd network.")
